...
{ 
  ...
  ros::NodeHandle n;
  ros::Publisher pb = n.advertise<naoqi_bridge_msgs::JointAnglesWithSpeedActionGoal>("/joint_angles_action/goal", 1000); ///nao_robot/pose/joint_angles_action/goal", 1000); 
